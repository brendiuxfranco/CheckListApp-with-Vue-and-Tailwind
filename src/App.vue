<template>
  <div class="h-screen w-widht bg-blue-300 flex flex-col justify-center items-center">
    <div class="header">
      <h1 class="text-4xl">🚀 My Important List App With Tailwind and Vue 🚀</h1>
      <div class="form flex">
        <input
          v-model="newTodo"
          @keyup="checkAdd"
          ...
          id="newText"
          type="text"
          placeholder="Add new Check List"
        />
        <button
          id="newBtn"
          @click="add"
          class="bg-yellow-500 hover:bg-orange-700 text-white font-bold py-2 px-4"
        >Add</button>
      </div>
    </div>
      ...
      <div class="pendings" v-if="totalPendings>0">
        ...
        <ul id="pendingList">
          <li
            ...
            class="text-center p-3 bg-pink mt-4 rounded shadow-lg cursor-pointer hover:bg-purple-500"
          >{{pending}}</li>
        </ul>
      </div>
      <div class="completed mt-8" v-if="totalCompleted>0">
        ...
        <ul id="completedList">
          <li
            ...
            class="text-center p-3 bg-white line-through text-brown-500 mt-4 rounded shadow-lg cursor-pointer hover:bg-white-500 hover:text-white"
          >{{completed}}</li>
        </ul>
      </div>
    </div>
